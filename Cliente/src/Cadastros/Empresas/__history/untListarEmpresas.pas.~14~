...
var
  Confirmacao: integer;
begin
  Confirmacao := Application.MessageBox('Deseja realmente excluir a empresa?', 'Confirmação', MB_ICONINFORMATION + MB_YESNO);
